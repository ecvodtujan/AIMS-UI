...
{
    public partial class AssetDocumentcontrol : UserControl
    {
        ...
        public AssetDocumentcontrol(AssetMasterform _Parent)
        {
            InitializeComponent();
            _parent = _Parent;
        }

        private void AssetDocumentcontrol_Load(object sender, EventArgs e)
        {
            AssetRepository _i = new AssetRepository();
            try
            {
                DisplayRecord(_i.GetAssetDocument(_parent._asset_id, 0));
        ...
        void DisplayRecord(INV_ASSET_DOCUMENT _obj)
        {
            try
            {
                if (_obj != null)
        ...
        void DisplayAssetDocuments()
        {
            ...
            try
            {
                List<INV_ASSET_DOCUMENT> _files = _i.GetAssetDocuments(_parent._asset_id);
                foreach (INV_ASSET_DOCUMENT _list in _files)
                {
                    n = dgvDoc.Rows.Add();
        ...
        private void dgvDoc_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            try
            {
                ...
                DisplayRecord(_i.GetAssetDocument(_parent._asset_id, _id));
        ...
        {
            AssetRepository _i = new AssetRepository();
            string _path = _i.GetDocumentPath(_parent._asset_id, _id);
        ...
        {
            AssetRepository _i = new AssetRepository();
            INV_ASSET_DOCUMENT _file = new INV_ASSET_DOCUMENT();

            try
            {
                _file.asset_id = _parent._asset_id;
                _file.id = _id;
                ...
                _id = _i.ManageAssetDocument(_file, _mode);
                ...
                {
                    _id = _i.ManageScannedAssetDocument(_file, _mode);
                }
                else
                {
